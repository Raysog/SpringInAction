...
import com.rayzog.repetit.dao.UserAgentReader;
...
public class LoginController {
    ...
    @Autowired
    public LoginController(UserAgentReader userAgentReader){
    ...
    public String checkLogin(
        ...
        boolean isUserExist = userAgentReader.findUserByUserLogin(loginForm);
